...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,2053,2083,2087,2096,8443,%GameFilterTCP% --wf-udp=443,19294-19344,27000-27300,50000-50100,%GameFilterUDP% ^
--filter-udp=27000-27300 --ipset="%LISTS%ipset-gloria-victis.txt" --dpi-desync=fake --dpi-desync-repeats=2 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp=0x12340100000100000000000006676f6f676c6503636f6d0000010001 --new ^
