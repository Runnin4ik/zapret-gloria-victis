...
--filter-udp=27000-27300 --ipset="%LISTS%ipset-gloria-victis.txt" --ipset="%LISTS%ipset-gloria-victis.txt" --dpi-desync=fake --dpi-desync-any-protocol=1 --dpi-desync-cutoff=n3 --dpi-desync-fake-unknown-udp="%BIN%stun.bin" --new ^
